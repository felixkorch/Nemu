...
class CPU {
   ...
   private:
    ...
    unsigned InstructionSize(AddressMode mode) {
        switch (mode) {
            case AddressMode::Immediate:
                return InstructionSizeImmediate;
            case AddressMode::Absolute:
                return InstructionSizeAbsolute;
            case AddressMode::AbsoluteX:
                return InstructionSizeAbsoluteX;
            case AddressMode::AbsoluteY:
                return InstructionSizeAbsoluteY;
            case AddressMode::Indirect:
                return InstructionSizeIndirect;
            case AddressMode::Relative:
                return InstructionSizeRelative;
            case AddressMode::Zeropage:
                return InstructionSizeZeropage;
            case AddressMode::ZeropageX:
                return InstructionSizeZeropageX;
            case AddressMode::ZeropageY:
                return InstructionSizeZeropageY;
            case AddressMode::IndirectX:
                return InstructionSizeIndirectX;
            case AddressMode::IndirectY:
                return InstructionSizeIndirectY;
            case AddressMode::Implied:
                return InstructionSizeImplied;
            default:
                return InstructionSizeImmediate;
        }
    }
    ...
    std::uint16_t GetAddress(AddressMode mode) {
        switch (mode) {
            case AddressMode::Immediate:
                return GetAddressImmediate();
            case AddressMode::Absolute:
                return GetAddressAbsolute();
            case AddressMode::AbsoluteX:
                return GetAddressAbsoluteX();
            case AddressMode::AbsoluteY:
                return GetAddressAbsoluteY();
            case AddressMode::Relative:
                return GetAddressRelative();
            case AddressMode::Zeropage:
                return GetAddressZeropage();
            case AddressMode::ZeropageX:
                return GetAddressZeropageX();
            case AddressMode::ZeropageY:
                return GetAddressZeropageY();
            case AddressMode::IndirectX:
                return GetAddressIndirectX();
            case AddressMode::IndirectY:
                return GetAddressIndirectY();
            default:
                return GetAddressImmediate();
        }
    }
    ...
    void Decode()  // Fetches & decodes an instruction
    {
        ...
        switch (ReadMemory(regPC)) {
            case 0x00:
                ...
                break;
            case 0xA0:
                OpLD(AddressMode::Immediate, regY);
                break;
            case 0xA4:
                OpLD(AddressMode::Zeropage, regY);
                break;
            case 0xB4:
                OpLD(AddressMode::ZeropageX, regY);
                break;
            case 0xAC:
                OpLD(AddressMode::Absolute, regY);
                break;
            case 0xBC:
                OpLD(AddressMode::AbsoluteX, regY);
                break;
            case 0xA2:
                OpLD(AddressMode::Immediate, regX);
                break;
            case 0xA6:
                OpLD(AddressMode::Zeropage, regX);
                break;
            case 0xB6:
                OpLD(AddressMode::ZeropageY, regX);
                break;
            case 0xAE:
                OpLD(AddressMode::Absolute, regX);
                break;
            case 0xBE:
                OpLD(AddressMode::AbsoluteY, regX);
                break;
            case 0xEA:
                OpNOP();
                break;
            ...
            case 0x78:
                ...
                break;
            case 0xA9:
                OpLD(AddressMode::Immediate, regA);
                break;
            case 0xA5:
                OpLD(AddressMode::Zeropage, regA);
                break;
            case 0xB5:
                OpLD(AddressMode::ZeropageX, regA);
                break;
            case 0xAD:
                OpLD(AddressMode::Absolute, regA);
                break;
            case 0xBD:
                OpLD(AddressMode::AbsoluteX, regA);
                break;
            case 0xB9:
                OpLD(AddressMode::AbsoluteY, regA);
                break;
            case 0xA1:
                OpLD(AddressMode::IndirectX, regA);
                break;
            case 0xB1:
                OpLD(AddressMode::IndirectY, regA);
                break;
            case 0x69:
                OpADC(AddressMode::Immediate);
                break;
            case 0x65:
                OpADC(AddressMode::Zeropage);
                break;
            case 0x75:
                OpADC(AddressMode::ZeropageX);
                break;
            case 0x6D:
                OpADC(AddressMode::Absolute);
                break;
            case 0x7D:
                OpADC(AddressMode::AbsoluteX);
                break;
            case 0x79:
                OpADC(AddressMode::AbsoluteY);
                break;
            case 0x61:
                OpADC(AddressMode::IndirectX);
                break;
            case 0x71:
                OpADC(AddressMode::IndirectY);
                break;
            case 0xE9:
                OpSBC(AddressMode::Immediate);
                break;
            case 0xE5:
                OpSBC(AddressMode::Zeropage);
                break;
            case 0xF5:
                OpSBC(AddressMode::ZeropageX);
                break;
            case 0xED:
                OpSBC(AddressMode::Absolute);
                break;
            case 0xFD:
                OpSBC(AddressMode::AbsoluteX);
                break;
            case 0xF9:
                OpSBC(AddressMode::AbsoluteY);
                break;
            case 0xE1:
                OpSBC(AddressMode::IndirectX);
                break;
            case 0xF1:
                OpSBC(AddressMode::IndirectY);
                break;
            case 0x85:
                OpST(AddressMode::Zeropage, regA);
                break;
            case 0x95:
                OpST(AddressMode::ZeropageX, regA);
                break;
            case 0x8D:
                OpST(AddressMode::Absolute, regA);
                break;
            case 0x9D:
                OpST(AddressMode::AbsoluteX, regA);
                break;
            case 0x99:
                OpST(AddressMode::AbsoluteY, regA);
                break;
            case 0x81:
                OpST(AddressMode::IndirectX, regA);
                break;
            case 0x91:
                OpST(AddressMode::IndirectY, regA);
                break;
            case 0x86:
                OpST(AddressMode::Zeropage, regX);
                break;
            case 0x96:
                OpST(AddressMode::ZeropageY, regX);
                break;
            case 0x8E:
                OpST(AddressMode::Absolute, regX);
                break;
            case 0x84:
                OpST(AddressMode::Zeropage, regY);
                break;
            case 0x94:
                OpST(AddressMode::ZeropageX, regY);
                break;
            case 0x8C:
                OpST(AddressMode::Absolute, regY);
                break;
            case 0x4C:
                OpJMPAbsolute();
                break;
            ...
            case 0x70:
                ...
                break;
            case 0x24:
                OpBIT(AddressMode::Zeropage);
                break;
            case 0x2C:
                OpBIT(AddressMode::Absolute);
                break;
            case 0x88:
                OpDEY();
                break;
            ...
            case 0xC6:
                ...
                break;
            case 0xD6:
                OpDEC(AddressMode::ZeropageX);
                break;
            case 0xCE:
                OpDEC(AddressMode::Absolute);
                break;
            case 0xDE:
                OpDEC(AddressMode::AbsoluteX);
                break;
            case 0x8A:
                OpTXA();
                break;
            ...
            case 0x0A:
                ...
                break;
            case 0x06:
                OpASL(AddressMode::Zeropage);
                break;
            case 0x16:
                OpASL(AddressMode::ZeropageX);
                break;
            case 0x0E:
                OpASL(AddressMode::Absolute);
                break;
            case 0x1E:
                OpASL(AddressMode::AbsoluteX);
                break;
            case 0x4A:
                OpLSRImplied();
                break;
            case 0x46:
                OpLSR(AddressMode::Zeropage);
                break;
            case 0x56:
                OpLSR(AddressMode::ZeropageX);
                break;
            case 0x4E:
                OpLSR(AddressMode::Absolute);
                break;
            case 0x5E:
                OpLSR(AddressMode::AbsoluteX);
                break;
            case 0x2A:
                OpROLImplied();
                break;
            case 0x26:
                OpROL(AddressMode::Zeropage);
                break;
            case 0x36:
                OpROL(AddressMode::ZeropageX);
                break;
            case 0x2E:
                OpROL(AddressMode::Absolute);
                break;
            case 0x3E:
                OpROL(AddressMode::AbsoluteX);
                break;
            case 0x6A:
                OpRORImplied();
                break;
            case 0x66:
                OpROR(AddressMode::Zeropage);
                break;
            case 0x76:
                OpROR(AddressMode::ZeropageX);
                break;
            case 0x6E:
                OpROR(AddressMode::Absolute);
                break;
            case 0x7E:
                OpROR(AddressMode::AbsoluteX);
                break;
            case 0x29:
                OpAND(AddressMode::Immediate);
                break;
            case 0x25:
                OpAND(AddressMode::Zeropage);
                break;
            case 0x35:
                OpAND(AddressMode::ZeropageX);
                break;
            case 0x2D:
                OpAND(AddressMode::Absolute);
                break;
            case 0x3D:
                OpAND(AddressMode::AbsoluteX);
                break;
            case 0x39:
                OpAND(AddressMode::AbsoluteY);
                break;
            case 0x21:
                OpAND(AddressMode::IndirectX);
                break;
            case 0x31:
                OpAND(AddressMode::IndirectY);
                break;
            case 0xC9:
                OpCMP(AddressMode::Immediate, regA);
                break;
            case 0xC5:
                OpCMP(AddressMode::Zeropage, regA);
                break;
            case 0xD5:
                OpCMP(AddressMode::ZeropageX, regA);
                break;
            case 0xCD:
                OpCMP(AddressMode::Absolute, regA);
                break;
            case 0xDD:
                OpCMP(AddressMode::AbsoluteX, regA);
                break;
            case 0xD9:
                OpCMP(AddressMode::AbsoluteY, regA);
                break;
            case 0xC1:
                OpCMP(AddressMode::IndirectX, regA);
                break;
            case 0xD1:
                OpCMP(AddressMode::IndirectY, regA);
                break;
            case 0xE0:
                OpCMP(AddressMode::Immediate, regX);
                break;
            case 0xE4:
                OpCMP(AddressMode::Zeropage, regX);
                break;
            case 0xEC:
                OpCMP(AddressMode::Absolute, regX);
                break;
            case 0xC0:
                OpCMP(AddressMode::Immediate, regY);
                break;
            case 0xC4:
                OpCMP(AddressMode::Zeropage, regY);
                break;
            case 0xCC:
                OpCMP(AddressMode::Absolute, regY);
                break;
            case 0x09:
                OpORA(AddressMode::Immediate);
                break;
            case 0x05:
                OpORA(AddressMode::Zeropage);
                break;
            case 0x15:
                OpORA(AddressMode::ZeropageX);
                break;
            case 0x0D:
                OpORA(AddressMode::Absolute);
                break;
            case 0x1D:
                OpORA(AddressMode::AbsoluteX);
                break;
            case 0x19:
                OpORA(AddressMode::AbsoluteY);
                break;
            case 0x01:
                OpORA(AddressMode::IndirectX);
                break;
            case 0x11:
                OpORA(AddressMode::IndirectY);
                break;
            case 0x49:
                OpEOR(AddressMode::Immediate);
                break;
            case 0x45:
                OpEOR(AddressMode::Zeropage);
                break;
            case 0x55:
                OpEOR(AddressMode::ZeropageX);
                break;
            case 0x4D:
                OpEOR(AddressMode::Absolute);
                break;
            case 0x5D:
                OpEOR(AddressMode::AbsoluteX);
                break;
            case 0x59:
                OpEOR(AddressMode::AbsoluteY);
                break;
            case 0x41:
                OpEOR(AddressMode::IndirectX);
                break;
            case 0x51:
                OpEOR(AddressMode::IndirectY);
                break;
            case 0xE6:
                OpINC(AddressMode::Zeropage);
                break;
            case 0xF6:
                OpINC(AddressMode::ZeropageX);
                break;
            case 0xEE:
                OpINC(AddressMode::Absolute);
                break;
            case 0xFE:
                OpINC(AddressMode::AbsoluteX);
                break;
            case 0xE8:
                OpINX();
                break;
